        ...
        <div className="border-bottom d-flex flex-column mr-4 pb-3 mb-3">
          <div className="d-flex justify-content-between ">
            <div className="mx-4 my-4 d-flex">
              <label style={ { fontSize: 'xxx-large', height: 'auto', alignSelf: 'flex-end' } }>Open Edgeware IDE</label>
            </div>
            ...
            <div className="mb-3">
              ...
              <div className="d-flex flex-row pt-2">
                <ThemeContext.Provider value={ state.themeQuality }>
                  ...
                  <PluginButton imgPath="assets/img/sourcifyNewLogo.webp" envID="sourcifyLogo" envText="Openware Cli" callback={() => startSourceVerify()} />
